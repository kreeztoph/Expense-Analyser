...
def December_2025_Variable(data):
    ...
    with col4:
        st.metric(
            "December Variable Cost Budget",
            value=f"£{data_Variable_Budget:,.2f}",
            border=True,
            help="This is the total amount budgeted to be spent for Variable Costs in December.",
        )
    with col5:
        st.metric(
            "December Variable Cost Spent",
            value=f"£{data_Variable_Spent:,.2f}",
            border=True,
            help="This is the total amount spent for Variable Cost inDecember.",
        )
    with col6:
        st.metric(
            "December Variable Cost Delta",
            value=f"£{data_Variable_Delta:,.2f}",
            border=True,
            delta=f"{data_Variable_Delta_Percent:,.2f}%",
            help="This is the difference in the budgeted amount and Spent amount for Variable Costs in December.",
        )
