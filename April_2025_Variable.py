...
def April_2025_Variable(data):
    ...
    with col1:
        st.metric(
            ...
            border=True,
            help="This is the total budget for April.",
        )
    with col2:
        st.metric(
            "April Spent",
            ...
            border=True,
            help="This is the total amount of funds spent in April.",
        )
    with col3:
        st.metric(
            "April Delta",
            ...
            help="This is the difference in the amount budgeted and the amount spent for April.",
        )
    with col4:
        st.metric(
            "April Variable Cost Budget",
            value=f"£{data_Variable_Budget:,.2f}",
            border=True,
            help="This is the total amount budgeted to be spent for Variable Costs in April.",
        )
    with col5:
        st.metric(
            "April Variable Cost Spent",
            value=f"£{data_Variable_Spent:,.2f}",
            border=True,
            help="This is the total amount spent for Variable Cost in April.",
        )
    with col6:
        st.metric(
            "April Variable Cost Delta",
            value=f"£{data_Variable_Delta:,.2f}",
            border=True,
            delta=f"{data_Variable_Delta_Percent:,.2f}%",
            help="This is the difference in the budgeted amount and Spent amount for Variable Costs in April.",
        )
