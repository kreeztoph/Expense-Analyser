...
def June_2025_Variable(data):
    ...
    with col1:
        st.metric(
            ...
            border=True,
            help="This is the total budget for June.",
        )
    with col2:
        st.metric(
            "June Spent",
            ...
            border=True,
            help="This is the total amount of funds spent in June.",
        )
    with col3:
        st.metric(
            "June Delta",
            ...
            help="This is the difference in the amount budgeted and the amount spent for June.",
        )
    with col4:
        st.metric(
            "June Variable Cost Budget",
            value=f"£{data_Variable_Budget:,.2f}",
            border=True,
            help="This is the total amount budgeted to be spent for Variable Costs in June.",
        )
    with col5:
        st.metric(
            "June Variable Cost Spent",
            value=f"£{data_Variable_Spent:,.2f}",
            border=True,
            help="This is the total amount spent for Variable Cost inJune.",
        )
    with col6:
        st.metric(
            "June Variable Cost Delta",
            value=f"£{data_Variable_Delta:,.2f}",
            border=True,
            delta=f"{data_Variable_Delta_Percent:,.2f}%",
            help="This is the difference in the budgeted amount and Spent amount for Variable Costs in June.",
        )
