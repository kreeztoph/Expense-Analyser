...
def November_2025_Variable(data):
    ...
    with col1:
        st.metric(
            ...
            border=True,
            help="This is the total budget for November.",
        )
    with col2:
        st.metric(
            "November Spent",
            ...
            border=True,
            help="This is the total amount of funds spent in November.",
        )
    with col3:
        st.metric(
            "November Delta",
            ...
            help="This is the difference in the amount budgeted and the amount spent for November.",
        )
    with col4:
        st.metric(
            "November Variable Cost Budget",
            value=f"£{data_Variable_Budget:,.2f}",
            border=True,
            help="This is the total amount budgeted to be spent for Variable Costs in November.",
        )
    with col5:
        st.metric(
            "November Variable Cost Spent",
            value=f"£{data_Variable_Spent:,.2f}",
            border=True,
            help="This is the total amount spent for Variable Cost inNovember.",
        )
    with col6:
        st.metric(
            "November Variable Cost Delta",
            value=f"£{data_Variable_Delta:,.2f}",
            border=True,
            delta=f"{data_Variable_Delta_Percent:,.2f}%",
            help="This is the difference in the budgeted amount and Spent amount for Variable Costs in November.",
        )
